...
| <a name="input_burst_credit_balance_alarm_enabled"></a> [burst\_credit\_balance\_alarm\_enabled](#input\_burst\_credit\_balance\_alarm\_enabled) | Whether to create the BurstCreditBalance alarm. Disable this for EFS file systems that do not publish burst credit metrics, such as elastic throughput file systems. | `bool` | `false` | no |
